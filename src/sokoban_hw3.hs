...
data Coord = C Integer Integer | None deriving Show
...
initialState :: State
initialState = State (C 0 1) R (Entry (C 3 2) Empty)
...
drawState (State c d bc) = pictureOfMaze
